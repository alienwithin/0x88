...
if ( isset( $_POST['UserName'], $_POST['Pass'], $_POST['Re'] ) )
{
    ...
    if ( 0 < $num )
    {
        $message = "Такой пользователь уже существует, выберите другой логин";
    }
...
echo $_POST['Re'];
echo "\"></td>\r\r\n\t\t<td align=\"center\"><input type=\"submit\" value=\"Создать\" class=button1 onmouseover=\"this.style.backgroundColor = '#3E3E3E'\" onmouseout=\"this.style.backgroundColor = '#4B4B4B'\"></td>\r\r\n\t</tr>\r\r\n</form>\r\r\n</table>\r\r\n\r\r\n<br>\r\r\n\r\r\n";
if ( $message != "" )
{
